...
export const HeroSection: React.FC = () => {
    ...
    // Fonction pour générer les variants d'animation sécurisés
    ...
    return (
        <>
            <section
                ref={heroRef}
                className="relative pt-20 pb-20 md:pt-22 md:pb-32 overflow-hidden bg-white dark:bg-black"
            >
                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <motion.div variants={safeAnimationVariants} custom={0}>
                                <Link
                  ...
                  <span className="absolute -bottom-1 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-700 to-transparent"></span>
                            ...
                            >
                                <Link
                                    to="/contact"
                                    className="px-8 py-4 bg-black dark:bg-white text-white dark:text-black text-base font-medium rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 ease-in-out border border-transparent focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-black"
                                >
                  <span className="flex items-center justify-center">
                    ...
                    <svg className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                                ...
                                <Link
                                    to="/projects"
                                    className="px-8 py-4 border border-gray-300 dark:border-gray-700 rounded-lg text-base font-medium text-black dark:text-white hover:bg-gray-50 dark:hover:bg-gray-900/30 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-black transition-all duration-300 ease-in-out"
                                >
                        ...
                        >
                            <div className="relative inline-block rounded-2xl overflow-hidden shadow-2xl">
                                {/* Image principale ou visualisation de code */}
                                <div className="aspect-square md:aspect-[4/3] w-full max-w-lg mx-auto lg:ml-auto overflow-hidden bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
                                    <img
                                        src="/noise.png" // Remplacez par votre image
                                ...
                                <AnimatePresence>
                                    {showFoxZen && (
                                        <motion.div
                                            className="absolute bottom-4 right-4 w-28 h-28 md:w-36 md:h-36 z-10"
                            ...
                            <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-16 h-16">
                                <svg className="w-full h-full text-gray-200 dark:text-gray-800" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900/50 border-t border-b border-gray-200 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-black dark:text-white flex items-center">
                            <span className="bg-black dark:bg-white w-8 h-[2px] inline-block mr-4"></span>
                            Nos Outils <span className="text-gray-500 dark:text-gray-400 ml-2">Open Source</span>
                        </h2>
                        <p className="mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400">
                            Des applications utiles développées par nos soins, accessibles à tous
                            et témoignant de notre expertise.
                        </p>
                    </motion.div>
